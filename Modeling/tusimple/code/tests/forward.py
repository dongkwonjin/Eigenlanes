...
class Forward_Model(object):
    ...
    def initialize_for_nms(self, data, model, iteration, thresd_nms_iou, thresd_nms_iou_upper, thresd_score):

        out = dict(
            batch_size=data['prob'].shape[0],
            thresd_nms_iou=thresd_nms_iou,
            thresd_nms_iou_upper=thresd_nms_iou_upper,
        ...
        model.thresd_nms_iou_upper = out['thresd_nms_iou_upper']
