...
class Config(object):
    ...
    def setting_for_path(self):
        ...
        self.dir['pre3'] = self.dir['head_proj'] + 'P03_clustering/output_{}/pickle/'.format(self.datalist)
    ...
    def setting_for_clustering(self):
        ...
        self.n_clusters['all_iter'] = 500  # do clustering iteratively
    ...
    def setting_for_training_label_generation(self):
        ...
        self.thresd_iou = 0.55
        self.thresd_iou_error = 0.4